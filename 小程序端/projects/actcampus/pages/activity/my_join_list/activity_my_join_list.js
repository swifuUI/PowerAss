...
Page({
	...
	_getSearchMenu: function () {
		let sortMenus = [
			{ label: '全部', type: '', value: '' },
			{ label: '时间▽', type: 'sort', value: 't1.ACTIVITY_START|desc' },
			{ label: '时间△', type: 'sort', value: 't1.ACTIVITY_START|asc' },
		]
	...
	bindCancelTap: async function (e) {
		...
		let callback = () => {
			pageHelper.delListNode(activityJoinId, this.data.dataList.list, 'activityJoinId');
