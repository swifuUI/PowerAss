...
import com.cclinux.projects.actcampus.service.admin.AdminUserService;
...
@RestController("ActCampusAdminUserController")
public class AdminUserController extends BaseMyAdminController {

    @Resource(name = "ActCampusAdminUserService")
    ...
    public ApiResult exportUserJoinExcel(@RequestBody Map<String, Object> input) {
        ...
        // 业务
        Map<String, Object> ret = adminUserService.exportUserJoinExcel();
