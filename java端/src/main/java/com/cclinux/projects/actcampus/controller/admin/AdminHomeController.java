...
import com.cclinux.projects.actcampus.service.admin.AdminHomeService;
...
@RestController("ActCampusAdminHomeController")
public class AdminHomeController extends BaseMyAdminController {

    @Resource(name = "ActCampusAdminHomeService")
