...
import com.cclinux.projects.actcampus.mapper.AdminMapper;
 ...
 */
@Service("ActCampusAdminHomeService")
public class AdminHomeService extends BaseMyAdminService {

    @Resource(name = "ActCampusAdminMapper")
    ...
    public ArrayList adminHome() {
        ...
        long activityCnt = activityMapper.count(new Where<ActivityModel>());
